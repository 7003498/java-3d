...
public class Ventana2 extends javax.swing.JFrame  {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            modeloCinematico.setVelocidad(Double.parseDouble(jTextField2.getText()));// TODO add your handling code here:
            modeloCinematico.setOmega(Double.parseDouble(jTextField1.getText()));
        } catch (Exception e) {
